...
for numeric_name in IMAGE_SIZE BATCHSIZE GCG_STEPS GCG_BATCH_SIZE MAX_VICTIM_QUERIES CLEAN_CORRECT_SAMPLE_SIZE GCG_SCENE_VOCAB_SIZE GCG_SCENE_VOCAB_PROMPTS_PER_STRATEGY GCG_SLOT_CANDIDATE_MAX_WORDS GCG_SCENE_FEEDBACK_LIMIT; do
...
Core environment overrides:
  ...
  CLEAN_CORRECT_SAMPLE_SEED, CLEAN_CORRECT_SKIP, CLEAN_CORRECT_COUNT
